    ...
    <>
      <div>
        ...
        >
          ...
          <Modal.Body>
            <iframe width="100%" height="514" src={`${video?.emdedLink}?autoplay=1`} title="Full Video: Galliyan Song | Ek Villain | Ankit Tiwari | Sidharth Malhotra | Shraddha Kapoor" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          </Modal.Body>
